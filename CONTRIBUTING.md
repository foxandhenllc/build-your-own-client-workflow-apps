# Contributing to Build Your Own Client Workflow Apps

Build Your Own Client Workflow Apps is part of the Fox & Hen public tool set. Contributions should keep the project useful, inspectable, forkable, and safe to demonstrate in public.

## Good First Contributions

- Add or improve a synthetic sample scenario that demonstrates: Project-based tutorials for building practical client workflow apps such as portals, quote trackers, CSV cleaners, pricing tools, and triage boards.
